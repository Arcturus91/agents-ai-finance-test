...
def get_travel_duration(start_location: str, destination_location: str, transportation_mode: Optional[str] = None) -> str:
    ...
    try:
        ...
        print(e)
        return e
agent = CodeAgent(tools=[get_travel_duration], model=HfApiModel(model_id="Qwen/Qwen2.5-Coder-32B-Instruct",
token=os.getenv("HF_API_KEY"),
max_tokens=5000,), additional_authorized_imports=["datetime"])
